...
$(()=>{
    ...
    if($(".a3").offset().top-scrollTop <innerHeight) {
        console.log(222)
        $(".a3").addClass("fadeInDown")
    }
        if($(".a1").offset().top-scrollTop <innerHeight) {
            console.log(222)
            $(".a1").addClass("fadeInDown")
        }
        if($(".a2").offset().top-scrollTop <innerHeight) {
            console.log(222)
            $(".a2").addClass("fadeInDown")
        }
    })
